...
export default async function EditPage({ params }: { params: { id: string; panelId: string } }) {
  const supabase = createClient();
  const { data: panel } = await supabase.from('panels').select('*').eq('id', params.panelId).single();
